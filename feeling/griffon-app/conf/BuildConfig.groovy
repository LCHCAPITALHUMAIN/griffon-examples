...
griffon.project.dependency.resolution = {
    ...
    repositories {
		...
		mavenRepo "http://download.java.net/maven/2/org/jaudiotagger/"
    }
    dependencies {
        // specify dependencies here under either 'build', 'compile', 'runtime', 'test' or 'provided' scopes eg.
        runtime 'uk.co.caprica:vlcj:1.1.5.1'
		runtime 'com.sun.jna:jna:3.3.0-b0'
		runtime 'com.sun.jna:platform:3.3.0-b0'
...
app.fileType = '.groovy'
app.defaultPackageName = 'feeling'
